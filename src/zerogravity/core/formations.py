...
def is_formation_pair(
    ...
    if iss_match:
        ...
        iss_related_1 = norad_id1 in iss_ids or any(
            k.upper() in name1_upper for k in KNOWN_FORMATIONS["iss_keywords"]
        )
        iss_related_2 = norad_id2 in iss_ids or any(
            k.upper() in name2_upper for k in KNOWN_FORMATIONS["iss_keywords"]
        )
